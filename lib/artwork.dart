            ...
            Row(
              ...
              children: [
                IconButton(
                  ...
                  color: Colors.brown,
                  onPressed: () => {_setShowDescription()},
                ),
                IconButton(
                  icon: const Icon(Icons.favorite),
                  color: _isFavorite ? Colors.red : Colors.brown,
                  onPressed: () => {_setIsFavorite(), showSnackBar()},
                ),
              ],
            )
          ],
